...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure edtPrincipalChange(Sender: TObject);
    ...
    procedure lblPrincipalClick(Sender: TObject);
    procedure lblRateClick(Sender: TObject);
...
procedure TForm1.edtPrincipalChange(Sender: TObject);
begin
...
procedure TForm1.lblPrincipalClick(Sender: TObject);
begin

end;

procedure TForm1.lblRateClick(Sender: TObject);
begin

end;

procedure TForm1.lblTimeClick(Sender: TObject);
begin
